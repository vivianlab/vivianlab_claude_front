    ...
    showConfirm(
      ...
      async () => {
        try {
          ...
          showAlert('Error', 'Failed to delete PDF. Please try again.', 'error');
        }
      },
      'error'
    );
    ...
    <>
      ...
      <Paper sx={{ p: 3, mt: 3 }}>
        ...
        <Typography variant="body1" color="text.secondary" sx={{ mb: 3 }}>
          Create, view, and manage PDF documents. Generate reports and download existing PDFs.
        </Typography>

        {/* Action Buttons Section */}
        <Box sx={{ mb: 4, display: 'flex', gap: 2, flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'center' }}>
          <Button
            variant="contained"
            startIcon={<AddIcon />}
                        ...
                        <Box sx={{ display: 'flex', gap: 1 }}>
                          ...
                          <Tooltip title="Delete PDF">
                            <IconButton
                              size="small"
                              color="error"
                              onClick={() => handleDeletePdf(pdf.id, pdf.fileName || pdf.filename)}
                            >
                              <DeleteIcon />
                            </IconButton>
                          </Tooltip>
        ...
        >
          ...
          <Box sx={{ mb: 3 }}>
            ...
            >
              ...
              <Typography variant="body2" color="text.secondary">
                {selectedFile ? 'File selected successfully' : 'Drag and drop or click to browse'}
              </Typography>
            </Box>
          </Box>
